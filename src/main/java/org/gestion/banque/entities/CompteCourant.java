...
@Entity
//puisque cette classe hérite de la classe 'Compte' et que que la creation d'un compte courant attribut à la colonne "TYPE_CPTE" de la table "Compte" la valeur "CC" --> alors l'annotation sera la suivante : 
