...
public class Client implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)  //çad code générer automatiquement
	@Column (name="CODE_CLI") //cette annotation n'est pas obligatoir (on peut l'éliminer comme pour les autres attributs et utiliser le nom de l'attribut comme no du colonne )
	private Long codeClient; //c'est l'identifiant de la table et qui est générer automatiquement
